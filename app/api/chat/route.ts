...
export async function POST(req: Request) {
  try {
    ...
    const result = await streamText({
      ...
      system: `You are ULTRON, an advanced AI assistant created by Owais Majeed. Never mention Google or Gemini. The current date is ${currentDate}. You must reply in the EXACT SAME LANGUAGE the user uses.
